...
| [0043](0043-native-uno-options-dialog.md) | Native UNO Options dialog for preference toggles (menu-driven, writes through the cached Preferences singleton) | G | Accepted |
